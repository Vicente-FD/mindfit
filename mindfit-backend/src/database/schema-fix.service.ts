...
export class SchemaFixService implements OnModuleInit {
  ...
  private async ensureFlotaLicencias(): Promise<void> {
  ...
  private async ensureMonitoreoIndexes(): Promise<void> {
    await this.dataSource.query(`
  ...
  private async ensureOportunidadesCrm(): Promise<void> {
    await this.dataSource.query(`
  ...
  private async ensureMovimientosInventario(): Promise<void> {
    await this.dataSource.query(`
